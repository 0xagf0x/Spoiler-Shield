// Spoiler Shield - Fixed Version (v1.7) - Prevents full page blur and hidden buttons
    ...
    getSiteSpecificSelectors() {
      ...
      if (hostname.includes("instagram.com")) {
        return [
          ...
          // BUT AVOID comments completely - don't include comment selectors
          // Comments are in: 'article ul li div span' - we specifically avoid these
        ];
      }
